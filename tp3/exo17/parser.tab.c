...
{
       1,     2,     9,    10,    11,    12,    16,    17,     7,     8,
       6,    18,    20,     0,    19,     0,     0,     0,    21
};

static const yytype_int8 yycheck[] =
{
       4,     5,    10,    11,     3,     4,     9,    10,     4,     0,
      12,     6,    18,    -1,     8,    -1,    -1,    -1,    19
};
...
#line 28 "parser.y"
                     { variables[yyvsp[-2]] = yyvsp[0]; printf("\nAffectation: %c = %d\n", yyvsp[-2], yyvsp[0]); }
...
#line 1129 "parser.tab.c"
  ...
  case 14: /* F: VARIABLE  */
#line 41 "parser.y"
            { yyval = variables[yyvsp[0]]; printf("\nRéduction F ----> variable $1=%c\t$$=%d\n", yyvsp[0], yyval); }
