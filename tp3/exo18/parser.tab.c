...
{
       1,     2,     9,    10,    11,    12,    18,    19,    16,    17,
      20,    21,    22,    23,     7,    24,    25,     6,     8
};

static const yytype_int8 yycheck[] =
{
       4,     5,    10,    11,     3,     4,     6,     7,     9,    10,
       8,     9,    18,    19,     4,    20,    21,    12,     0
};
...
{
       0,     4,     5,    14,    15,    16,    12,     4,     0,    10,
      11,     3,     4,    17,    18,    19,    15,    15,     6,     7,
       8,     9,    18,    18,    19,    19
};
...
#line 1087 "parser.tab.c"
  ...
  case 7: /* Stmt: VARIABLE '=' E  */
#line 28 "parser.y"
                     { variables[yyvsp[-2]] = yyvsp[0]; printf("Affectation: %c = %d\n", yyvsp[-2], yyvsp[0]); }
#line 1093 "parser.tab.c"
    break;

  case 8: /* Stmt: PRINT VARIABLE  */
#line 29 "parser.y"
                     { printf("Valeur de %c: %d\n", yyvsp[0], variables[yyvsp[0]]); }
